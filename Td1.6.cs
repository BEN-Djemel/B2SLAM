...
namespace Td1._6
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Clear();
            Console.WriteLine("Le taux d'interets pour un taux annuel à {0} %, le capital placé à hauteur de {1}, et une durée de {2} mois s'élève à {3} euros.", taux, capital, dureeMois, interet);
